...
class SitwShotItemWidget(ShotItemWidget, object):
    ...
    def get_fi_data(self):
        fi_widget = sitw_file_importer.SitwFileImporter(pkg_dir=self.pkg_dir, pkg_for='client', show_data=None)
        fi_widget.show()
        fi_widget.exec_()
...
if __name__ == '__main__':
    ...
    global_pkg_data = {'date': '2023_04_19', 'vendor': 'dasein', 'show': 'sitw', 'pkg_version_prefix': 'send', 'pkg_version_num': '01', 'pkg_dir': '/mnt/sitw/io/to-sitw', 'pkg_for': 'client', 'vendor_name': 'UNKNOWN'}
