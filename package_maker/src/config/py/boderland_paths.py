import lucidity
from package_maker.src.config.py.boderland_nomenclature import *
...
resolver_target_list = [
    ...
    VENDOR_SHOT_PKG_NAME, main_pkg_dir, shot_pkg_dir, for_approval_dir,
    vendor_discipline_folder_template
]
